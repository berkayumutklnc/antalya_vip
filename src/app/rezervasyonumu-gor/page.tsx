      ...
      <div className="rounded-xl border border-white/10 bg-white/[0.02] p-5 space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <input
            ...
            className="rounded-lg bg-neutral-900 border border-white/15 p-3 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-colors"
          />
          <input
            value={email}
        ...
        <button
          onClick={onSearch}
          disabled={loading}
          className={`px-5 py-2.5 rounded-lg font-semibold transition-all duration-200 ${loading ? "bg-neutral-700 cursor-not-allowed opacity-60" : "bg-blue-600 hover:bg-blue-700 active:scale-95 shadow-lg shadow-blue-600/20"}`}
        >
          {loading ? (
            ...
            {rec.cancel?.requested ? (
              ...
              <>
                ...
                <button
                  ...
                  disabled={cancelBusy}
                  className={`px-5 py-2.5 rounded-lg font-semibold transition-all duration-200 ${cancelBusy ? "bg-neutral-700 cursor-not-allowed opacity-60" : "bg-red-600 hover:bg-red-700 active:scale-95"}`}
                >
