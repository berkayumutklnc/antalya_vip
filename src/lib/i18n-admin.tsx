...
const dictionaries: Record<Lang, Dict> = {
  tr: {
    ...
    "nav.calendar": "Takvim",
    "nav.serviceCatalog": "Hizmet Kataloğu",
    "nav.pricing": "Fiyatlandırma",
    "pricing.title": "Rota Fiyatları",
    "pricing.addNew": "+ Yeni Fiyat",
    "serviceCatalog.title": "Hizmet Kataloğu",
    "serviceCatalog.variants": "Varyantlar",
    "dashboard.title": "Yönetim Paneli",
    "dashboard.subtitle": "Genel bakış ve hızlı erişim",
    "dashboard.openReservations": "Bekleyen rezervasyonlar",
    "dashboard.vehicles": "Kayıtlı araçlar",
    "dashboard.go": "Görüntüle",
  ...
  en: {
    ...
    "nav.pricing": "Pricing",
    "pricing.title": "Route Pricing",
    "pricing.addNew": "+ New Price",
    "serviceCatalog.title": "Service Catalog",
    "serviceCatalog.variants": "Variants",
    "dashboard.title": "Admin Dashboard",
    "dashboard.subtitle": "Overview and quick access",
  ...
  de: {
    ...
    "nav.serviceCatalog": "Dienstkatalog",
    "nav.pricing": "Preise",
    "pricing.title": "Routenpreise",
    "pricing.addNew": "+ Neuer Preis",
    "serviceCatalog.title": "Dienstkatalog",
    "serviceCatalog.variants": "Varianten",
    "dashboard.title": "Admin-Dashboard",
    "dashboard.subtitle": "Übersicht und Schnellzugriff",
    "dashboard.openReservations": "Offene Buchungen",
    "dashboard.vehicles": "Registrierte Fahrzeuge",
    "dashboard.go": "Anzeigen",
  ...
  ru: {
    ...
    "nav.serviceCatalog": "Каталог услуг",
    "nav.pricing": "Цены",
    "pricing.title": "Цены маршрутов",
    "pricing.addNew": "+ Новая цена",
    "serviceCatalog.title": "Каталог услуг",
    "serviceCatalog.variants": "Варианты",
    "dashboard.title": "Панель управления",
    "dashboard.subtitle": "Обзор и быстрый доступ",
    "dashboard.openReservations": "Открытые бронирования",
    "dashboard.vehicles": "Зарегистрированные авто",
    "dashboard.go": "Просмотр",
