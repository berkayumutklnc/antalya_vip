...
"step4.acceptComms": "Kampanya ve bilgilendirme mesajları almak istiyorum (opsiyonel)",
    ...
    "header.cta.book": "Teklif Al / Rezervasyon",
    ...
    "step3.title": "Servis Tipi Seçimi",
    ...
    "step4.row.vehicle": "Servis tipi",
    "step4.row.variant": "Paket",
    "step4.row.price": "Fiyat",
    "step4.row.basePrice": "Temel fiyat",
    "step4.row.surcharge": "Paket farkı",
    "step4.row.quotedTotal": "Teklif edilen toplam",
    "step4.quote.note": "Bu tutar rota, servis tipi ve paket seçiminize göre oluşturulan anlık tekliftir.",
    "step4.payment.note": "Online ödeme alınmaz. Kesin onay ve ödeme bilgisi operasyon ekibi tarafından paylaşılır.",
    "step4.back": "Geri",
    "step4.confirm": "Rezervasyon Talebi Gönder",
...
"rezervasyon.title": "Teklif Al ve Rezervasyon",
"consent.msg": "Bu web sitesi analiz amaçlı çerezler kullanmaktadır.",
"whatsapp.ariaLabel": "WhatsApp ile yazın",
"whatsapp.reserve": "WhatsApp'tan Teklif Al",
"landing.cta.book": "Şimdi Rezervasyon",
"landing.routes.title": "Rotalar & Süre",
"landing.routes.distance": "Antalya Havalimanı'ndan ~{km} km",
"landing.whyUs.title": "Niçin {name}?",
"landing.faq.title": "Sık Sorulanlar",
"landing.cta.title": "Hemen transferinizi rezerve edin",
"landing.cta.subtitle": "Şeffaf teklif • Online ödeme yok • 24 saat öncesine kadar ücretsiz iptal",
"landing.trust.flight": "Uçuş Takibi",
"landing.trust.flightDesc": "Uçuşunuzu takip ediyoruz — gecikmelerde ek ücret yok",
"landing.trust.child": "Ücretsiz Bebek Koltuğu",
"landing.trust.childDesc": "Her rezervasyonda ücretsiz çocuk koltuğu",
"landing.trust.price": "Sabit Fiyat",
"landing.trust.priceDesc": "Gördüğünüz fiyatı ödersiniz — gizli ücret yok",
"landing.trust.support": "7/24 Hizmet",
"landing.trust.supportDesc": "Tatiller dahil kesintisiz hizmet",
"landing.pricing.cta": "Teklif al ve rezervasyon talebi gönder",
"footer.transfer.title": "Transferler",
"footer.legal.impressum": "Künye",
"footer.legal.agb": "Genel Koşullar",
"footer.legal.datenschutz": "Gizlilik Politikası",
...
"step4.acceptComms": "I would like to receive offers and updates (optional)",
    ...
    "header.cta.whatsapp": "WhatsApp",
    "header.cta.book": "Get Quote / Reserve",
    ...
    "step3.title": "Choose Service Type",
    ...
    "step4.row.vehicle": "Service type",
    "step4.row.variant": "Package",
    "step4.row.price": "Price",
    "step4.row.basePrice": "Base price",
    "step4.row.surcharge": "Package surcharge",
    "step4.row.quotedTotal": "Quoted total",
    "step4.quote.note": "This amount is a live quote based on your route, service type and package.",
    "step4.payment.note": "No online payment is taken. Final confirmation and payment details are shared by our operations team.",
    "step4.back": "Back",
    "step4.confirm": "Send Reservation Request",
...
"rezervasyon.title": "Get Quote & Reserve",
"whatsapp.ariaLabel": "Write on WhatsApp",
"whatsapp.reserve": "Get Quote via WhatsApp",
"landing.cta.book": "Book Now",
"landing.routes.title": "Routes & Travel Times",
"landing.routes.distance": "~{km} km from Antalya Airport",
"landing.whyUs.title": "Why {name}?",
"landing.faq.title": "FAQ",
"landing.cta.title": "Book your transfer now",
"landing.cta.subtitle": "Transparent quoting • No online payment • Free cancellation up to 24h before",
"landing.trust.flight": "Flight Tracking",
"landing.trust.flightDesc": "We monitor your flight — no extra charge for delays",
"landing.trust.child": "Free Child Seat",
"landing.trust.childDesc": "Complimentary child seat on every booking",
"landing.trust.price": "Fixed Price",
"landing.trust.priceDesc": "The price you see is what you pay — no hidden fees",
"landing.trust.support": "24/7 Service",
"landing.trust.supportDesc": "Round-the-clock availability, even on holidays",
"landing.pricing.cta": "Get quote and send reservation request",
"footer.transfer.title": "Transfers",
"footer.legal.impressum": "Imprint",
"footer.legal.agb": "Terms & Conditions",
...
"step4.acceptComms": "Ich möchte Angebote & Updates erhalten (optional)",
    ...
    "header.cta.whatsapp": "WhatsApp",
    "header.cta.book": "Angebot / Buchung",
    ...
    "step3.title": "Service-Typ wählen",
    ...
    "step4.row.vehicle": "Service-Typ",
    "step4.row.variant": "Paket",
    "step4.row.price": "Preis",
    "step4.row.basePrice": "Grundpreis",
    "step4.row.surcharge": "Paketzuschlag",
    "step4.row.quotedTotal": "Angebotssumme",
    "step4.quote.note": "Dieser Betrag ist ein Live-Angebot basierend auf Route, Service-Typ und Paket.",
    "step4.payment.note": "Es gibt keine Online-Zahlung. Finale Bestätigung und Zahlungsdetails teilt unser Operationsteam mit.",
    "step4.back": "Zurück",
    "step4.confirm": "Buchungsanfrage senden",
...
"rezervasyon.title": "Angebot & Buchung",
"whatsapp.ariaLabel": "Schreiben Sie uns auf WhatsApp",
"whatsapp.reserve": "Angebot per WhatsApp",
"landing.cta.book": "Jetzt buchen",
"landing.routes.title": "Routen & Fahrtzeiten",
"landing.routes.distance": "~{km} km vom Flughafen Antalya",
"landing.whyUs.title": "Warum {name}?",
"landing.faq.title": "Häufige Fragen",
"landing.cta.title": "Jetzt Ihren Transfer buchen",
"landing.cta.subtitle": "Transparente Angebote • Keine Online-Zahlung • Kostenlose Stornierung bis 24h vorher",
"landing.trust.flight": "Flugverfolgung",
"landing.trust.flightDesc": "Wir verfolgen Ihren Flug — kein Aufpreis bei Verspätung",
"landing.trust.child": "Gratis Kindersitz",
"landing.trust.childDesc": "Kostenloser Kindersitz bei jeder Buchung",
"landing.trust.price": "Festpreis",
"landing.trust.priceDesc": "Der angezeigte Preis gilt — keine versteckten Kosten",
"landing.trust.support": "24/7 Service",
"landing.trust.supportDesc": "Rund um die Uhr erreichbar, auch an Feiertagen",
"landing.pricing.cta": "Angebot ansehen und Buchungsanfrage senden",
"footer.transfer.title": "Transfers",
...
"step4.acceptComms": "Хочу получать предложения и новости (необязательно)",
    ...
    "step3.title": "Выбор типа сервиса",
    ...
    "step4.row.vehicle": "Тип сервиса",
    "step4.row.variant": "Пакет",
    "step4.row.price": "Цена",
    "step4.row.basePrice": "Базовая цена",
    "step4.row.surcharge": "Доплата за пакет",
    "step4.row.quotedTotal": "Сумма по расчёту",
    "step4.quote.note": "Эта сумма является оперативным расчётом по вашему маршруту, типу сервиса и пакету.",
    "step4.payment.note": "Онлайн-оплаты нет. Финальное подтверждение и детали оплаты сообщает операционный отдел.",
    "step4.back": "Назад",
    "step4.confirm": "Отправить заявку на бронь",
...
"rezervasyon.title": "Расчёт и бронь",
"whatsapp.ariaLabel": "Напишите нам в WhatsApp",
"whatsapp.reserve": "Получить расчёт в WhatsApp",
"landing.cta.book": "Забронировать",
"landing.routes.title": "Маршруты и время в пути",
"landing.routes.distance": "~{km} км от аэропорта Анталии",
"landing.whyUs.title": "Почему {name}?",
"landing.faq.title": "Частые вопросы",
"landing.cta.title": "Забронируйте трансфер сейчас",
"landing.cta.subtitle": "Прозрачный расчёт • Без онлайн-оплаты • Бесплатная отмена до 24ч",
"landing.trust.flight": "Отслеживание рейса",
"landing.trust.flightDesc": "Мы следим за вашим рейсом — без доплат за задержки",
"landing.trust.child": "Бесплатное детское кресло",
"landing.trust.childDesc": "Детское кресло бесплатно при каждом бронировании",
"landing.trust.price": "Фиксированная цена",
"landing.trust.priceDesc": "Цена на сайте — окончательная, без скрытых платежей",
"landing.trust.support": "Сервис 24/7",
"landing.trust.supportDesc": "Работаем круглосуточно, включая праздники",
"landing.pricing.cta": "Узнать расчёт и отправить заявку",
"footer.transfer.title": "Трансферы",
"footer.legal.impressum": "Импрессум",
"footer.legal.agb": "Условия",
